...
The main reason to refactor code is to improve performance.  This is not always a good idea because the improved performance may not be worth the time or effort put in to get it.
